	...
	const sections = [	
							{
								...
								"rows": [
									{
										"title": "1️⃣ مذكرة محاسبة شركات 📘",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}commlido`
									},
									{
										"title": "2️⃣ مذكرة محاسبة شركات 📗",
										"description": "ماده محاسبة مؤسسات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}mcsslido`
										},
									{
										"title": "3️⃣ مذكرة محاسبة شركات 📕",
										"description": "ماده محاسبة ضريبة بواسطة بوت بكار 🐼",
										"rowId": `${prefix}rebalido`
										},
										{
										"title": "⏺ مذكرة امتحانات محاسبة شركات 📔",
										"description": "ماده تأمينات عامه بواسطة بوت بكار 🐼",
										"rowId": `${prefix}tminlido`
									},
										{
...
🔰︙تم برمجتي من قبل JOKER7x Team
🧑🏻‍💻︙مطوري »» 「 Dev Lido ☠️ مطور ليدو 」
💳︙رقمه »»  「 @${ownernya.split('@')[0]}」
⚙️︙وظيفتي حماية جروبك 
🎮︙يمكنك ايضا العب معي 
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار التحـكـم خاصة بالبوت💞`
				let ments = [ownernya, me, ini_mark]
				let buttons = [					
					{buttonId: `allmenu`, buttonText: {displayText: '● كل الاوامر ●'}, type: 1},
			        {buttonId: `command`, buttonText: {displayText: '● قائمة الاوامر ●'}, type: 1},
			        {buttonId: `eeeee`, buttonText: {displayText: '● العقرب 🦂'}, type: 2},
