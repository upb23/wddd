	...
	const time2 = moment().tz('Africa/Cairo').format('HH:mm:ss')  
	 if(time2 < "23:59:00"){
	var ucapanWaktu = `مساء الخير يقلبي 😍💕`
	 }
	 if(time2 < "19:00:00"){
	var ucapanWaktu = `مساء الخير يجميل🙂♥️`
	 }
	 if(time2 < "18:00:00"){
	var ucapanWaktu = `مساء الخير يروحي 🧸❤️‍🩹`
	 }
	 if(time2 < "15:00:00"){
	var ucapanWaktu = `مساؤؤ  الفل 😹🤓`
	 }
	 if(time2 < "11:00:00"){
	var ucapanWaktu = `يسعد صباحك الجميل 💝`
	 }
	 if(time2 < "05:00:00"){
	...
	//guess song
			...
			let isSurrender = !1
			//reply(`[DEBUG]\n${parseInt(m.text)}`)
			if (!/^([1-9]|(me)?give up|surr?ender|off|انسحاب)$/i.test(m.text)) return
...
${isWin ? `( @${winner.split('@')[0]} ) فاز` : isTie ? `انتهت اللعبة` : `*الدور للاعب 🌟 :* @${room.game.currentTurn.split('@')[0]}  ${['(❌)', '(⭕️)'][1 * room.game._currentTurn]}`}
	
*اللاعب الاول :*  @${room.game.playerX.split('@')[0]}  (❌)
*اللاعب الثاني :*  @${room.game.playerO.split('@')[0]}  (⭕️)
══════ ××× ══════
◍ لو عايز تنسحب اكتب ← انسحاب 
	`
	    ...
	    let win = ''
	    let tie = false
	    if (m.sender == roof.p2 && /^(ن(عم)?|accept|نعم|okay?|reject|no|لا|nope(k.)?yes|y)/i.test(m.text) && m.isGroup && roof.status == 'wait') {
	    if (/^(reject|no|لا|n|nope(k.)?yes)/i.test(m.text)) {
	    XeonBotInc.sendTextWithMentions(m.chat, `تم رفض التحدي من @${roof.p2.split`@`[0]} `, m)
	    ...
	    XeonBotInc.sendText(m.chat, `تم قبول التحدي 

@${roof.p.split`@`[0]} vs @${roof.p2.split`@`[0]}

*يجب عليكم الدخول الي البوت لجواب*
_ده شات البوت_ https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) XeonBotInc.sendText(roof.p, `يرجي الاختيار \n\nحجر🪨\nورقه📄\nمقص✂️`, m)
	    if (!roof.pilih2) XeonBotInc.sendText(roof.p2, `يرجي الاختيار \n\nحجر🪨\nورقه📄\nمقص✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) XeonBotInc.sendText(m.chat, `*تم الغاء التحدي* \nبسبب كلا اللاعبين لم يلعبوا`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    XeonBotInc.sendTextWithMentions(m.chat, `انتهي الوقت \nلقد خسر @${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} \n حاول مرة اخري`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    roof.text = m.text
	    reply(`لقد اخترت ${m.text} ${!roof.pilih2 ? `\n\n*يرجي انتظار أن يختار الخصم*` : ''}`)
	    if (!roof.pilih2) XeonBotInc.sendText(roof.p2, '_الخصم اختار_\nالآن حان دورك ', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    reply(`لقد اخترت ${m.text} ${!roof.pilih ? `\n\n*يرجي انتظار أن يختار الخصم*` : ''}`)
	    if (!roof.pilih) XeonBotInc.sendText(roof.p, '_الخصم اختار_\nالآن حان دورك', 0)
	    }
	    ...
	    XeonBotInc.sendText(roof.asal, `_*نتيجة التحدي*_${tie ? '\nSERIES' : ''}
...
*الدور للاعب 🌟 :* @${room.game.currentTurn.split('@')[0]}
	...
	◍ لو عايز تنسحب اكتب ← انسحاب 
	 `
	    ...
	    if (m.mentionedJid[0] === m.sender) return reply(`لا أستطيع اللعب مع نفسي!`)
            if (!m.mentionedJid[0]) return reply(`*لعبة حجر ورقة مقص*\n\n_ من تريد أن تتحدى؟ _\nيجب عمل منشن لشخص الذي تريد لعب معه\n\nمثال : ${prefix}suit @${owner[1]}`, m.chat, { mentions: [owner[1] + '@s.whatsapp.net'] })
            if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.mentionedJid[0])))  reply(`The Person You Are Challenging Is Playing Suit With Someone Else :(`)
            let id = 'suit_' + new Date() * 1
            let caption = `_*لعبة حجر ورقة مقص*_

@${m.sender.split`@`[0]} يدعوك يا  @${m.mentionedJid[0].split`@`[0]} الي لعب معه

@${m.mentionedJid[0].split`@`[0]} هل انت  تريد الي لعب مع @${m.sender.split`@`[0]} ؟ نعم/لا`
            this.suit[id] = {
            ...
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) XeonBotInc.sendText(m.chat, `_انتهي وقت الانتظار_`, m)
            delete this.suit[id]
	...
	Cieeee, What's Going Onâ¤ï¸ðŸ’–ðŸ‘€`
		...
		break
	case 'اضافة': case 'add': case 'اضافه': {
			if (!m.isGroup) throw mess.group
					if (!isBotAdmins) throw mess.botAdmin
					if (!isAdmins) throw mess.admin
		...
		break
		case 'رفع_مشرف': case 'ادمن': case 'مشرف': case 'promote': {
			if (!m.isGroup) throw mess.group
					if (!isBotAdmins) throw mess.botAdmin
					if (!isAdmins) throw mess.admin
			let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		...
		break
		case 'تنزيل_مشرف': case 'تنزيل': case 'demote': {
			if (!m.isGroup) throw mess.group
					if (!isBotAdmins) throw mess.botAdmin
					if (!isAdmins) throw mess.admin
			let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
			...
			case 'اسم': case 'وضع_اسم': {
			  ...
			  case 'setbotpp': {
			   ...
			   case 'setpp': case 'وضع': case 'ضع': {
					...
					m.reply('تم تغيرها بنجاح')
					}
					break
	case 'تاك_لكل': case 'all': case 'تاك': case 'tagall': {
					if (!m.isGroup) throw mess.group
					if (!isBotAdmins) throw mess.botAdmin
					if (!isAdmins) throw mess.admin
	let teks = `*◍ ⇜ ${q ? q : 'لايوجد رسالة'}*\n\n`
				...
				break
case 'زخرفه': case 'زخرفة': case 'style': case 'styletext': {
			...
			if (!text) throw 'Enter Query text!'
					...
					let teks = `نتائج الزخرفة › ${text}\n\n`
					for (let i of anu) {
						teks += `${themeemoji} ›  ${i.result}\n\n`
					}
					m.reply(teks)
			}
			break
	...
	*${prefix}deletevote* - to delete votes
	...
	break
			case 'deletevote': case'delvote': case 'hapusvote': {
				...
				break
		 case 'group': case 'الجروب': case 'جروب': {
					if (!m.isGroup) throw mess.group
					if (!isBotAdmins) throw mess.botAdmin
					if (!isAdmins) throw mess.admin
					if (args[0] === 'close'){
						await XeonBotInc.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`*• تم قفل جروب بنجاح يقلبي 🥺💔*`)).catch((err) => m.reply(jsonformat(err)))
					} else if (args[0] === 'open'){
						await XeonBotInc.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`*• تم فتح جروب بنجاح يقلبي 😂♥️*`)).catch((err) => m.reply(jsonformat(err)))
					} else {
					let buttons = [
							{ buttonId: 'group open', buttonText: { displayText: 'فتح الجروب' }, type: 1 },
							{ buttonId: 'group close', buttonText: { displayText: 'قفل الجروب' }, type: 1 }
						]
				...
				case 'editinfo': case 'تعديل': {
					...
					if (!isAdmins) throw mess.admin
				 if (args[0] === 'open'){
					await XeonBotInc.groupSettingUpdate(m.chat, 'unlocked').then((res) => m.reply(`*•  تم فتح تعديل معلومات جروب لكل الاعضاء 😍❤️*`)).catch((err) => m.reply(jsonformat(err)))
				 } else if (args[0] === 'close'){
					await XeonBotInc.groupSettingUpdate(m.chat, 'locked').then((res) => m.reply(`*•  تم قفل تعديل معلومات جروب للمشرفين فقط 🙂💙*`)).catch((err) => m.reply(jsonformat(err)))
				 } else {
				 let buttons = [
							{ buttonId: 'editinfo open', buttonText: { displayText: 'فتح كل الاعضاء' }, type: 1 },
							{ buttonId: 'editinfo close', buttonText: { displayText: 'قفل للمشرفين فقط' }, type: 1 }
						]
	...
	break
				case 'رابط_جروب': case 'لينك_جروب': case 'الرابط': case 'رابط': case 'لينك': case 'gclink': {
					if (!m.isGroup) throw mess.group
					if (!isBotAdmins) throw mess.botAdmin
	...
	await XeonBotInc.sendMessage(i, { video:media,  caption: txt, mentions:participants.map(a => a.id) })
			...
			break
				case 'listpc': {
				 ...
				 break
	case 'sticker': case 'sss': case 'تحويل_ملصق': case 'sgif': {
				if (!quoted) throw `*اكتب تحويل_ملصق بالرد علي صورة او gif او فيديو بحد اقصي 10 ثواني !*`
				m.reply(mess.wait)
						if (/image/.test(mime)) {
					let media = await quoted.download()
					...
					throw `*اكتب تحويل_ملصق بالرد علي صورة او gif او فيديو بحد اقصي 10 ثواني !*`
					}
				}
				break
				case '			': {
	...
	break
		...
		case 'smeme': case 'ملصق_باسمك': case 'stickmeme': {
	...
	break
case 'تحويل_صورة': case 'تحويل_صوره': case 'toimage': case 'toimg': {
					if (!quoted) throw 'Reply Image'
					if (!/webp/.test(mime)) throw `* اكتب تحويل_صوره بالرد علي الملصق*`
					m.reply(mess.wait)
					let media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
				...
				break
case 'تحويل_فيديو': case 'tomp4': case 'tovideo': {
					if (!quoted) throw 'Reply Image'
					if (!/webp/.test(mime)) throw `* اكتب تحويل_فيديو بالرد علي ملصق *`
					m.reply(mess.wait)
			let { webp2mp4File } = require('./lib/uploader')
				...
				break
				case 'تحويل_ريكورد': case 'toaudio': {
				if (!/video/.test(mime) && !/audio/.test(mime)) throw `*◍ »*  تحويل_ريك بالرد علي ملف صوتي او فيديو`
				if (!quoted) throw `*◍ »*  تحويل_ريك بالرد علي ملف صوتي او فيديو`
				m.reply(mess.wait)
				let media = await quoted.download()
				...
				break
	case 'ت_mp3': case 'تحويل_mp3': case 'tomp3': {
				if (/document/.test(mime)) throw `*◍ »*  تحويل_mp3  بالرد علي ريك او فيديو `
				if (!/video/.test(mime) && !/audio/.test(mime)) throw `*◍ »*  تحويل_mp3  بالرد علي ريك او فيديو `
				if (!quoted) throw `*◍ »*  تحويل_mp3  بالرد علي ريك او فيديو `
				m.reply(mess.wait)
				let media = await quoted.download()
				let { toAudio } = require('./lib/converter')
				let audio = await toAudio(media, 'mp4')
				...
				break
case 'تحويل_ريك': case 'ت_ريك': case 'tovn': case 'toptt': {
				if (!/video/.test(mime) && !/audio/.test(mime)) throw `*◍ »*  تحويل_ريك بالرد علي ملف صوتي او فيديو `
				if (!quoted) throw `*◍ »*  تحويل_ريك بالرد علي ملف صوتي او فيديو `
				m.reply(mess.wait)
				let media = await quoted.download()
				...
				break
		case 'ت_gif': case 'تحويل_gif': case 'togif': {
					if (!quoted) throw 'Reply video'
					if (!/webp/.test(mime)) throw `* اكتب تحويل_gif بالرد علي ملصق *`
					m.reply(mess.wait)
			let { webp2mp4File } = require('./lib/uploader')
					let media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
					let webpToMp4 = await webp2mp4File(media)
				...
				break
case 'مسح_خلفيه': case 'مسح_خلفية': case 'مسح_الخلفيه': case 'مسح_خلفيه': case 'removebg': case 'remove-bg': {
			if (!quoted) throw `*◍ »*  مسح_خلفيه بالرد علي الصورة `
			if (!/image/.test(mime)) throw `*◍ »*  مسح_خلفيه بالرد علي الصورة `
			if (/webp/.test(mime)) throw `*◍ »*  مسح_خلفيه بالرد علي الصورة `
			...
			break
		case 'تحميل': case 'yts': case 'ytsearch': {
					...
					for (let i of search.all) {
						teks += `${themeemoji} رقم : ${no++}\n${themeemoji} النوع : ${i.type}\n${themeemoji} ايدي الفيديو : ${i.videoId}\n${themeemoji} العنوان : ${i.title}\n${themeemoji} مشاهدات : ${i.views}\n${themeemoji} المدة : ${i.timestamp}\n${themeemoji} Uploaded : ${i.ago}\n${themeemoji} لينك : ${i.url}\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n\n`
					}
					XeonBotInc.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
				}
				break
		case 'جوجل': case 'google': {
					if (!text) throw `*◍ ⇜ جوجل + اللي عايز تبحث عليه*`
					let google = require('google-it')
					google({'query': text}).then(res => {
					let teks = `نتائج بحث في جوجل : ${text}\n\n`
					for (let g of res) {
					...
					break
case 'بحث_فيديو': case 'بحث2': case 'video': { 
	...
	case 'يوتيوب': case 'play': case 'ytplay':{
					if (!text) throw `*◍ ⇜ يوتيوب  +  رابط الفيديو*`
					let yts = require("youtube-yts")
					let search = await yts(text)
	...
	${themeemoji} ايدي الفيديو : ${anulay.videoId}
	${themeemoji} المدة : ${anulay.timestamp}
	${themeemoji} مشاهدون : ${anulay.views}
	${themeemoji} تم الرفع  : ${anulay.ago}
	${themeemoji} الفنان : ${anulay.author.name}
	${themeemoji} القناة : ${anulay.author.url}
	...
	break
	case 'صوت': case 'ytmp3': case 'ytaudio': //credit: Ray Senpai â¤ï¸ https://github.com/EternityBots/Nezuko
	...
	*◍ تم تحميل بواسطة » بوت بكار 🐼* `
	...
	case 'pinterest': {
			...
			break
				...
				let buttons = [
						{buttonId: `coffee`, buttonText: {displayText: '• صور اخري'}, type: 1}
					]
					let buttonMessage = {
						image: { url: 'https://coffee.alexflipnote.dev/random' },
						caption: ` *◍ رمزيات القهوة ☕️*`,
						footer: botname,
						buttons: buttons,
						headerType: 4
					}
	...
	break
	case 'تيكتوك': case 'tiktok':{ 
	if (!text) return m.reply( `*◍ »*  تيكتوك +رابط `)
	if (!q.includes('tiktok')) return m.reply(`*◍ رابط  غلط يروحي 😒😟*`)
	m.reply(mess.wait)
	require('./lib/tiktok').Tiktok(q).then( data => {
		var button = [{ buttonId: `tiktokaudio ${q}`, buttonText: { displayText: `صوت 🔊` }, type: 1 }, { buttonId: `owner`, buttonText: { displayText: `المطور 😍❤️` }, type: 1 }]
	XeonBotInc.sendMessage(m.chat, { caption: `*◍ تم تحميل بواسطة » بوت بكار 🐼* `, video: { url: data.watermark }, buttons: button, footer: botname, mentions: [sender] })
	})
	}
	break
	case 'صوت_تيكتوك': case 'tiktokaudio':{
	if (!text) return m.reply( `*◍ »*  صوت_تيكتوك +رابط `)
	if (!q.includes('tiktok')) return m.reply(`*◍ رابط  غلط يروحي 😒😟*`)
	m.reply(mess.wait)
	require('./lib/tiktok').Tiktok(q).then( data => {
	...
	break
case 'بنات_صينية': case 'chinese':
	m.reply(mess.wait)
	var but = [{buttonId: `chinese`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/china.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ مزيات بنات صينية 🙎🏻‍♀️* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'بنات_بالحجاب': case 'hijab':
	m.reply(mess.wait)
	var but = [{buttonId: `hijab`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/hijab.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ رمزيات بنات بالحجاب🙎🏻‍♀️*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'بنات_اندو': case 'indo':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/indonesia.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ رمزيات بنات اندونيسيا🙎🏻‍♀️*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'بنات_يابانية': case 'japanese':
	m.reply(mess.wait)
	var but = [{buttonId: `japanese`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/japan.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ رمزيات بنات يابانية 🙎🏻‍♀️*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'korean': case 'بنات_كورية':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/korea.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ رمزيات بنات كورية 🙎🏻‍♀️* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'بنات_مالي': case 'malay':
	m.reply(mess.wait)
	var but = [{buttonId: `malay`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/malaysia.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ رمزيات بنات ماليزيا🙎🏻‍♀️*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'بنات_افتار': case 'randomgirl':
	m.reply(mess.wait)
	var but = [{buttonId: `randomgirl`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/random.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ افتار بنات🙎🏻‍♀️*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'شباب_افتار': case 'randomboy':
	m.reply(mess.wait)
	var but = [{buttonId: `randomboy`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/random2.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ افتار شباب🙎🏻*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'بنات_تايلاندية': case 'thai':
	m.reply(mess.wait)
	var but = [{buttonId: `thai`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/thailand.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ رمزيات بنات تايلاندية🙎🏻‍♀️*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'بنات_فيتنامية': case 'vietnamese':
	m.reply(mess.wait)
	var but = [{buttonId: `vietnamese`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/tiktokpics/vietnam.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ رمزيات بنات فيتنامية🙎🏻‍♀️* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'جمالي_افتار': case 'aesthetic':
	m.reply(mess.wait)
	var but = [{buttonId: `aesthetic`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/aesthetic.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `  *◍ افتارات 📷* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'موتور': case 'bike':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	...
	XeonBotInc.sendMessage(m.chat, { caption: `  *◍ افتارات 📷* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'رعب': case 'boneka':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/boneka.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: ` *◍ افتار رعب😈* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'تنكري': case 'cosplay':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/cosplay.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `  *◍ افتار تنكري 🧑🏻‍🎤* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'ميوو': case 'cat':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: "• صور اخري" }, type: 1 }]
	...
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `*◍  افتارات قطط ميوو 🐈*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'جرو': case 'doggo':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: "• صور اخري" }, type: 1 }]
	...
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `*◍  افتارات جرو 🐕*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
	case 'justina':
	m.reply(mess.wait)
...
case 'سياره': case 'car':
	m.reply(mess.wait)
	var but = [{buttonId: `car`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/car.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `*◍  افتارات سيارات 🏎*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
	case 'صوره_كوبل': case 'couplepicture':
	m.reply(mess.wait)
	var but = [{buttonId: `couplepicture`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/ppcouple.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `*◍  افتارات كوبل 💞*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
	case 'بروفايل': case 'profilepicture':
	m.reply(mess.wait)
	var but = [{buttonId: `profilepicture`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/profile.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `*◍  افتارات بروفايل 👤*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
case 'ببجي': case 'pubg':
	m.reply(mess.wait)
	var but = [{buttonId: `pubg`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/pubg.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `*◍ افتارات ببجي 💂🏻* `, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
	case 'rose':
	m.reply(mess.wait)
	var but = [{buttonId: `${command}`, buttonText: { displayText: "NEXTâž¡ï¸" }, type: 1 }]
	...
	XeonBotInc.sendMessage(m.chat, { caption: mess.success, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
	case 'الفون': case 'wallphone':
	m.reply(mess.wait)
	var but = [{buttonId: `wallphone`, buttonText: { displayText: " • صور اخري" }, type: 1 }]
	var notnot = JSON.parse(fs.readFileSync('./HostMedia/randompics/wallhp.json'))
	var hasil = pickRandom(notnot)
	XeonBotInc.sendMessage(m.chat, { caption: `*◍ افتارات خلفيات فون 📱*`, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
	break
	...
	break
case 'رنة': case 'رنه': case 'نغمة': case 'ringtone': {
	...
	*List Hash*
	...
	m.reply('*• تم تعطيل حظر روابط قنوات يوتيوب 📴*')
	  ...
	  let buttonsntilink = [
	  { buttonId: `${command} on`, buttonText: { displayText: 'تفعيل حظر روابط قنوات يوتيوب' }, type: 1 },
	  { buttonId: `${command} off`, buttonText: { displayText: 'تعطيل حظر روابط قنوات يوتيوب' }, type: 1 }
	  ]
	  await XeonBotInc.sendButtonText(m.chat, buttonsntilink, `⏬ اختار من الازرار بالاسفل \n\n  ⏪ تفعيل حظر روابط قنوات يوتيوب\n  ⏪ تعطيل حظر روابط قنوات يوتيوب`, `${global.botname}`, m)
	  }
	  }
	  break
	...
	m.reply('Success in turning off facebook antilink in this group')
	  ...
	  break
	case 'رابط_تلي': case 'لينك_تلي': case 'antilinktelegram': case 'antilinktg': {
	if (!m.isGroup) return m.reply(mess.group)
	if (!isBotAdmins) return m.reply(mess.botAdmin)
	if (!isAdmins && !isCreator) return m.reply(mess.admin)
	if (args[0] === "on") {
	if (AntiLinkTelegram) return m.reply('*• تم تفعيل سابقا⚠️*')
	ntilinktg.push(from)
	fs.writeFileSync('./database/antilinktelegram.json', JSON.stringify(ntilinktg))
	m.reply('*• تم تفعيل حظر روابط تليجرام ⚠️*')
	var groupe = await XeonBotInc.groupMetadata(from)
	var members = groupe['participants']
	var mems = []
	members.map(async adm => {
	...
	XeonBotInc.sendMessage(from, {text: `\`\`\`*• تم تفعيل حظر روابط تليجرام ⚠️*\`\`\`\n\n*• يتم حظر اي رابط تليجرام يتم ارساله فورا والطرد ⚠️*`, contextInfo: { mentionedJid : mems }}, {quoted:m})
	} else if (args[0] === "off") {
	if (!AntiLinkTelegram) return m.reply('*• تم تعطيل سابقا 📴*')
	...
	m.reply('*• تم تعطيل حظر روابط تليجرام 📴*')
	  ...
	  let buttonsntilink = [
	  { buttonId: `${command} on`, buttonText: { displayText: ' تفعيل حظر روابط تليجرام' }, type: 1 },
	  { buttonId: `${command} off`, buttonText: { displayText: '  تعطيل حظر روابط تليجرام' }, type: 1 }
	  ]
	  await XeonBotInc.sendButtonText(m.chat, buttonsntilink, `⏬ اختار من الازرار بالاسفل \n\n  ⏪ تفعيل حظر روابط تليجرام\n  ⏪ تعطيل حظر روابط تليجرام`, `${global.botname}`, m)
	  }
	  }
	  break
	case 'رابط_تيكتوك': case 'لينك_تيكتوك': case'antilinktiktok': case 'antilinktt': {
	if (!m.isGroup) return m.reply(mess.group)
	if (!isBotAdmins) return m.reply(mess.botAdmin)
	if (!isAdmins && !isCreator) return m.reply(mess.admin)
	if (args[0] === "on") {
	if (AntiLinkTiktok) return m.reply('*• تم تفعيل سابقا⚠️*')
	ntilinktt.push(from)
	fs.writeFileSync('./database/antilinktiktok.json', JSON.stringify(ntilinktt))
	m.reply('*• تم تفعيل حظر روابط تيك توك⚠️*')
	var groupe = await XeonBotInc.groupMetadata(from)
	var members = groupe['participants']
	var mems = []
	members.map(async adm => {
	...
	XeonBotInc.sendMessage(from, {text: `\`\`\`*• تم تفعيل حظر روابط تيك توك⚠️*\`\`\`\n\n*• يتم حظر اي رابط تيك توك يتم ارساله فورا والطرد ⚠️*`, contextInfo: { mentionedJid : mems }}, {quoted:m})
	} else if (args[0] === "off") {
	if (!AntiLinkTiktok) return m.reply('*• تم تعطيل سابقا 📴*')
	let off = ntilinktt.indexOf(from)
	ntilinktt.splice(off, 1)
	fs.writeFileSync('./database/antilinktiktok.json', JSON.stringify(ntilinktt))
	m.reply('*• تم تعطيل حظر روابط تيك توك📴*')
	} else {
	  let buttonsntilink = [
	  { buttonId: `${command} on`, buttonText: { displayText: 'تفعيل حظر روابط تيك توك' }, type: 1 },
	  { buttonId: `${command} off`, buttonText: { displayText: 'تعطيل حظر روابط تيك توك' }, type: 1 }
	  ]
	  await XeonBotInc.sendButtonText(m.chat, buttonsntilink, `⏬ اختار من الازرار بالاسفل \n\n  ⏪ تفعيل حظر روابط تيك توك\n  ⏪ تعطيل حظر روابط تيك توك`, `${global.botname}`, m)
	  }
	  }
	  break
	...
	m.reply('Success in turning off antiwame in this group')
	  ...
	  break
	case 'رابط_جروبات': case 'لينك_جروبات': case 'antilinkgc': {
	if (!m.isGroup) return m.reply(mess.group)
	if (!isBotAdmins) return m.reply(mess.botAdmin)
	if (!isAdmins && !isCreator) return m.reply(mess.admin)
	if (args[0] === "on") {
	if (Antilinkgc) return m.reply('*• تم تفعيل سابقا⚠️*')
	ntlinkgc.push(from)
	fs.writeFileSync('./database/antilinkgc.json', JSON.stringify(ntlinkgc))
	m.reply('*• تم تفعيل حظر روابط الجروبات ⚠️*')
	var groupe = await XeonBotInc.groupMetadata(from)
	var members = groupe['participants']
	var mems = []
	members.map(async adm => {
	...
	XeonBotInc.sendMessage(from, {text: `\`\`\`*• تم تفعيل حظر روابط الجروبات ⚠️*\`\`\`\n\n*• يتم حظر اي رابط لجروب واتساب يتم ارساله فورا والطرد ⚠️*`, contextInfo: { mentionedJid : mems }}, {quoted:m})
	} else if (args[0] === "off") {
	if (!Antilinkgc) return m.reply('*• تم تعطيل سابقا 📴*')
	let off = ntlinkgc.indexOf(from)
	ntlinkgc.splice(off, 1)
	fs.writeFileSync('./database/antilinkgc.json', JSON.stringify(ntlinkgc))
	m.reply('*• تم تعطيل حظر روابط الجروبات 📴*')
	} else {
	  let buttonsntwame = [
	  { buttonId: `${command} on`, buttonText: { displayText: 'تفعيل حظر روابط الجروبات' }, type: 1 },
	  { buttonId: `${command} off`, buttonText: { displayText: 'تعطيل حظر روابط الجروبات' }, type: 1 }
	  ]
	  await XeonBotInc.sendButtonText(m.chat, buttonsntwame, `⏬ اختار من الازرار بالاسفل \n\n⏪ تفعيل حظر جروبات\n⏪ تعطيل حظر جروبات`, `${global.botname}`, m)
	  }
	  }
	  break
...
case 'تلقائي': case 'autosticker':
	...
	m.reply('Success in turning off nsfw in this group')
	  ...
	  break
	case 'ميديا': case 'mediafire': {
	if (!text) throw mess.linkm
	if (!isUrl(args[0]) && !args[0].includes('mediafire.com')) throw `*◍ رابط  غلط يروحي 😒😟*`
	...
	*${themeemoji} Lyrics :-* \n
	...
	console.log(lyrics)
	 await XeonBotInc.sendMessage(m.chat, {text:txt},{quoted:m})
		...
		break
	case 'صور_جوجل': case 'gimage': {
		   if (!text) throw `Example : ${prefix + command} kaori cicak`
			xeonezyanu = await fetchJson(`https://api.akuari.my.id/search/googleimage?query=${text}`)
			n = xeonezyanu.result
			images = n[Math.floor(Math.random() * n.length)]
			let buttons = [
						{buttonId: `gimage ${text}`, buttonText: {displayText: 'صور اخري'}, type: 1}
					]
					let buttonMessage = {
						image: { url: images },
						caption: `*------- نتائج بحث صور جوجل -------*
	${themeemoji} *الاسم* : ${text}
	${themeemoji} *لينك* : ${images}`,
						footer: botname,
						buttons: buttons,
						headerType: 4
					}
	...
	break
case 'ايموجي': case 'emoji': {
	if (!args.join(" ")) return m.reply('*اكتب ايموجي + الايموجي اللي عايزه*')
	emoji.get(args.join(" ")).then(async(emoji) => {
	let mese = await XeonBotInc.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `تم صنع بواسطة : ${global.botname}`}, {quoted:m})
	await XeonBotInc.sendMessage(from, {text:"*ملحوظة : يمكن الرد علي صورة > بتحويل_ملصق >> لتحويلها الي ملصق *"}, {quoted:mese})
	})
	}
	break
case 'الصوت': case 'volume': {
	if (!args.join(" ")) return m.reply(`*مثال* : الصوت 10 بالرد علي  ملف صوتي او فيديو `)
	...
	m.reply(mess.wait)						
	 waifudd = await axios.get(`https://nekos.life/api/v2/img/woof`)
							   var wbuttsss = [
			{buttonId: `woof`, buttonText: {displayText: ` • صور اخري`}, type: 1},
			]
		  let buttonssMessages = {
		   image: {url:waifudd.data.url},
		   caption:  `◍ رمزيات الكلاب 🐶*`,
	...
	m.reply(mess.wait)						
	 waifudd = await axios.get(`https://nekos.life/api/v2/img/meow`)
							   var wbuttsss = [
			{buttonId: `meow`, buttonText: {displayText: ` • صور اخري`}, type: 1},
			]
		  let buttonssqMessages = {
		   image: {url:waifudd.data.url},
		   caption:  `*◍ رمزيات القطط 🐱*`,
		  footer: `${global.botname}`,
		  buttons: wbuttsss,
		  headerType: 4
		  }     
	...
	m.reply(mess.wait)						
	 waifudd = await axios.get(`https://nekos.life/api/v2/img/lizard`)
							   var wbuttsss = [
			{buttonId: `lizard`, buttonText: {displayText: ` • صور اخري`}, type: 1},
			]
		  let buttonsswMessages = {
		   image: {url:waifudd.data.url},
		   caption:  `*◍ رمزيات الحرباية🦎*`,
		  footer: `${global.botname}`,
		  buttons: wbuttsss,
		  headerType: 4
		  }     
	...
	m.reply(mess.wait)						
	 waifudd = await axios.get(`https://nekos.life/api/v2/img/smug`)
							   var wbuttsss = [
			{buttonId: `.${command}`, buttonText: {displayText: `• صور اخري`}, type: 1},
			]
	...
	m.reply(mess.wait)
	 ...
	 let xxhnekobot = [
		{buttonId: `.nom`, buttonText: {displayText: `• صور اخري`}, type: 1},
		]
	...
	m.reply(mess.wait)						
	   waifud = await axios.get('https://waifu.pics/api/sfw/neko')
					var wbutsss = [
			{buttonId: `animeneko`, buttonText: {displayText: `• صور اخري`}, type: 1},
			]
		  let buttonssMessage = {
	...
	var wbutsss = [
		{buttonId: `.shinobu`, buttonText: {displayText: `• صور اخري`}, type: 1},
			 ]
	...
	var wbutsss = [
		{buttonId: `.megumin`, buttonText: {displayText: `• صور اخري`}, type: 1},
			 ]
		  let buttonzMessage = {
		  image: {url:ud.data.url},
		   caption:  `*◍  الانمي *`,
...
case 'السحري': case 'سحري': case 'can': {
...
case 'pfcheck':
case 'جمالي':
					if (!text) return m.reply(`*جمالي + تاك  & مثال : جمالي @lido  .*`)
	...
	XeonBotInc.sendMessage(from, { text: `◍ نسبه الجمال هي ~⪼  *${ssange}%* 🙂❤️` }, { quoted: m })
						break
case 'lovelycheck':
case 'الحب':
case 'حب':
					if (!text) return m.reply(`*الحب + تاك  & مثال : الحب @lido  .*`)
	...
	XeonBotInc.sendMessage(from, { text: `◍ نسبه الحب بينكم هى ~⪼  *${stimo}%* 🥰💕` }, { quoted: m })
						break	
case 'tghcheck':
case 'النجاح':
case 'نجاح':
					if (!text) return m.reply(`*النجاح + تاك  & مثال : النجاح @lido  .*`)
	...
	XeonBotInc.sendMessage(from, { text: `◍ نسبه النجاح هي ~⪼  *${tsussus}%* 🙂🤓` }, { quoted: m })
						break
case 'yuyucheck':
case 'كره':
case 'الكره':
					if (!text) return m.reply(`*الكره + تاك  & مثال : الكره @lido  .*`)
	...
	XeonBotInc.sendMessage(from, { text: `◍ نسبه الكره بينكم هى ~⪼  *${eliee}%* 🙄💔` }, { quoted: m })
						break						
case 'reqscheck':
case 'الغباء':
case 'غباء':
	...
	XeonBotInc.sendMessage(from, { text: `◍ نسبه الكره بينكم هى ~⪼  *${wrdas}%* 🙄💔` }, { quoted: m })
						break	
	...
	case 'toqr':{
	  ...
	  break
	case 'انستا': case 'ig': case 'instagram': case 'انستجرام': { //credit: Ray Senpai â¤ï¸ https://github.com/EternityBots/Nezuko
	...
	break
	case 'سبوتيفي': case 'سبوت': case 'spotify': //credit: Ray Senpaiâ¤ï¸ https://github.com/EternityBots/Nezuko
	if (!text) return m.reply(`*◍ »*  سبوتيفي +رابط`)
			const Spotify = require('./lib/spotify')
			const spotify = new Spotify(text)
			const info = await spotify.getInfo()
			if ((info).error) throw `The link you provided is not spotify link`
			const { name, artists, album_name, release_date, cover_url } = info
			const details = `${themeemoji}  *العنوان :* ${name || ''}\n${themeemoji}  *الفنان :* ${(artists || []).join(
				','
			)}\n${themeemoji} *الالبوم :* ${album_name}\n${themeemoji} *تاريخ النشر :* ${release_date || ''}`
	...
	case 'duthgsf': case 'الدعم': {
	teks = `*ــــــــــــــــــــــــــــــــــــــــــــ*\n*◍ مرحبا بك يا ${pushname} في الدعم الفنـي  خاص بالبوت*\n*◍ تابع قناة تحديثات البوت علي تلي  ⏬* \n-› https://t.me/UPDATE_BAKAR\n*◍ يوجد بها حلول كل مشاكل*  \n*◍ يمكن مراسلة  مطور البوت عبر واتساب ⇊* \n -›〘 @201028453763  -  @201554496598⁩ 〙\n*ــــــــــــــــــــــــــــــــــــــــــــ*\n*⤵️︙ اليـكـ زر المطور البوت 🧑🏻‍💻*`
	let buttons = [
	...
	//------------------------The End----------------------\\
	///-------------------- مذكرات ترم التاني --------------\\
	case 'المواد': case 'مواد': case 'tslido': {
		const sections = [	
								{
									"title": "⏺ قائمة مواد ترم التاني",
									"rows": [
										{
											"title": "1️⃣ ماده محاسبة شركات",
											"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
											"rowId": `${prefix}commlido`
										},
										{
											"title": "2️⃣ محاسبة مؤسسات",
											"description": "ماده محاسبة مؤسسات بواسطة بوت بكار 🐼",
											"rowId": `${prefix}mcsslido`
											},
										{
											"title": "3️⃣ محاسبة ضريبة",
											"description": "ماده محاسبة ضريبة بواسطة بوت بكار 🐼",
											"rowId": `${prefix}rebalido`
											},
											{
											"title": "4️⃣ تأمينات عامه ",
											"description": "ماده تأمينات عامه بواسطة بوت بكار 🐼",
											"rowId": `${prefix}tminlido`
										},
											{
											"title": "5️⃣ دراسات محاسبية باللغه الانجليزية ",
											"description": "ماده دراسات محاسبية باللغه الانجليزية بواسطة بوت بكار 🐼",
											"rowId": `${prefix}enlshlido`
											 },
											{
											"title": "6️⃣ تطبيقات الحاسب ",
											"description": "ماده تطبيقات الحاسب  بواسطة بوت بكار 🐼",
											"rowId": `${prefix}hasblido`
										}
									]
								},
								{
									"title": "Dev Lido ☠️ مطور ليدو",
									"rows": [
										{
											"title": "المطور 😍❤️",
											"description": "معلومات المطور ليدو حبيب الجمهور 😂💞",
											"rowId": `${prefix}lido7x`
										}
									]
								}
...
case 'commlido': {
	const sections = [	
							{
								"title": "⏺ قائمة مذكرات محاسبة شركات",
								"rows": [
									{
										"title": "1️⃣ مذكرة محاسبة شركات 1",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}comm2lido`
									},
									{
										"title": "2️⃣ مذكرة محاسبة شركات 2",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}comm3lido`
										},
									{
										"title": "3️⃣ مذكرة محاسبة شركات 3",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}comm4lido`
										},
										{
											"title": "4️⃣ مذكرة محاسبة شركات 4 جزء 1",
											"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
											"rowId": `${prefix}comm22lido`
											},
											{
												"title": "4️⃣ مذكرة محاسبة شركات 4 جزء 2",
												"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
												"rowId": `${prefix}comm23lido`
												},									{
										"title": "4️⃣ مذكرة محاسبة شركات 4 جزء 3",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}comm24lido`
										},	
										{
											"title": "4️⃣ مذكرة محاسبة شركات 4 جزء 4",
											"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
											"rowId": `${prefix}comm25lido`
											},
											{
												"title": "4️⃣ مذكرة محاسبة شركات 4 جزء 5",
												"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
												"rowId": `${prefix}comm225lido`
												},	
											{
												"title": "5️⃣ مذكرة مراجعة محاسبة شركات 5",
												"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
												"rowId": `${prefix}comm27lido`
												},	
										{
										"title": "*️⃣ مذكرة امتحانات محاسبة شركات",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
							...
							{
								"title": "⏺ قائمة شروحات محاسبة شركات (احمد عبود)",
								"rows": [
									{
							...
							{
								"title": "⏺ قائمة شروحات محاسبة شركات (محمد بخيت)",
								"rows": [
									{
									...
									{
										"title": "2️⃣ الحصة التانيه",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh2`
										},
									{
										"title": "3️⃣ الحصة الثالثه",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh3`
										},
										{
										"title": "4️⃣ الحصة الرابعة",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh4`
									},
									{
										"title": "5️⃣ الحصة الخامسه",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh5`
										},
									{
										"title": "6️⃣ الحصة السادسة",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh6`
										},
										{
										"title": "7️⃣ الحصة السابعة",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh7`
									},
										{
										"title": "8️⃣ الحصة الثامنة",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh8`
										 },
										{
										"title": "9️⃣ الحصة التاسعة والاخيرة",
										"description": "ماده محاسبة شركات بواسطة بوت بكار 🐼",
...
const listMessage = {
  text: "- ماده محاسبة شركات \n\n- اختار المذكرة من قائمة مذكرات ⬇️",
  footer: `- اختار الشرح من قائمة شروحات ⬇️ `,
  title: `- نورت يا ${pushname} \n `,
  buttonText: " الــقــائمــة",
  sections
}
const sendMsg = await XeonBotInc.sendMessage(m.chat, listMessage)
}
...
1️⃣ ❬ حصة الاولي  ❭ ⇊ 
════════ ××× ════════ٴ
⤶ حلقة موجودة في بوت علي تليجرام  

• الرابط -› https://t.me/MRLido7xBot?start=P0_0_0_0 
════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_0_1
	════════ ××× ════════ٴ
...
case 'hygfywsh3': 
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_0_2
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_1_0
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_1_1
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_1_2
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_2_0
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_2_1
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_2_2
	════════ ××× ════════ٴ
	...
	case 'محاسبة_شركات_1': case 'comm2lido': {
		let xeonwee = `
	ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة محاسبة شركات 1 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
		`
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm3lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
		let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_1.pdf'),
			fileName : `مذكرة محاسبة شركات 1`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
	...
	case 'محاسبة_شركات_2': case 'comm3lido': {
		let xeonwee = `
		ـــــــــــــــــــــــــــــــــــــــــــــ
		-›   ${ucapanWaktu}
		-›  نورت يا ${pushname} 
		-› خد يغالي/ة  مذكرة محاسبة شركات 2 🤗
		♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
		ـــــــــــــــــــــــــــــــــــــــــــــ
		⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
			`
			let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm4lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
			let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_2.pdf'),
			fileName : `مذكرة محاسبة شركات 2`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
	...
	case 'محاسبة_شركات_3': case 'comm4lido': {
		let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
		-›   ${ucapanWaktu}
		-›  نورت يا ${pushname} 
		-› خد يغالي/ة  مذكرة محاسبة شركات 3 🤗
		♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
		ـــــــــــــــــــــــــــــــــــــــــــــ
		⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm22lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
		let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_3.pdf'),
			fileName : `مذكرة محاسبة شركات 3`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
	...
	case 'محاسبة_شركات_4_جزء_1': case 'comm22lido': {
		let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة شركات 4 جزء 1🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm23lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
		let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_4_جزء_1.pdf'),
			fileName : `مذكرة محاسبة شركات 4 جزء 1`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
	...
	case 'محاسبة_شركات_4_جزء_2': case 'comm23lido': {
		let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة شركات 4 جزء 2
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm24lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
		let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_4_جزء_2.pdf'),
			fileName : `مذكرة محاسبة شركات 4 جزء 2`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
	...
	case 'محاسبة_شركات_4_جزء_3': case 'comm24lido': {
		let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة شركات 4 جزء 3 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm25lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
		let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_4_جزء_3.pdf'),
			fileName : `مذكرة محاسبة شركات 4 جزء 3`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
	...
	case 'محاسبة_شركات_4_جزء_4': case 'comm25lido': {
		let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة شركات 4 جزء 4 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️`
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm225lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
		let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_4_جزء_4.pdf'),
			fileName : `مذكرة محاسبة شركات 4 جزء 4`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
	...
	case 'محاسبة_شركات_4_جزء_5': case 'comm225lido': {
		let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة شركات 4 جزء 5 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️`
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm5lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
		let buttonMessage = { 
			document: fs.readFileSync('./XeonMedia/file/محاسبة_شركات_4_جزء_5.pdf'),
			fileName : `مذكرة محاسبة شركات 4 جزء 5`,
			mimetype: `application/pdf`,             
			caption: xeonwee,
			footer: botname,
	buttons: buttons,
...
case 'امتحانات_محاسبة_شركات': case 'comm5lido': {
	let xeonwee = `
	ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة امتحانات محاسبة شركات 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
		let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tslido', buttonText: { displayText: 'عودة الي قائمة المواد' }, type: 1 },{ buttonId: 'comm27lido', buttonText: { displayText: 'مــذكرة اخــري' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/امتحانات_محاسبة_شركات.pdf'),
		fileName : `مذكرة امتحانات محاسبة شركات`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'comm26lido': 
	...
	#️⃣ ❬ الكتاب  ❭ ⇊ 
════════ ××× ════════ٴ
⤶ كتاب موجود في بوت علي تليجرام  
	
• الرابط -› https://t.me/MRLido7xBot?start=P0_0_8_2
════════ ××× ════════ٴ
`
break
...
case 'comm27lido': 
	throw `
	#️⃣ ❬ مراجعة محاسبة شركات  ❭ ⇊ 
	════════ ××× ════════ٴ
	⤶ مراجعة موجودة في بوت علي تليجرام  
		
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_8_3
	════════ ××× ════════ٴ
	`
break
...
case 'mcsslido': {
	const sections = [	
							{
								"title": "⏺ قائمة مذكرات محاسبة مؤسسات",
								"rows": [
									{
										"title": "1️⃣ مذكرة محاسبة مؤسسات 1",
										"description": "ماده محاسبة مؤسسات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}mcss1lido`
									},
									{
										"title": "2️⃣ مذكرة محاسبة مؤسسات 2",
										"description": "ماده محاسبة مؤسسات بواسطة بوت بكار 🐼",
										"rowId": `${prefix}mcss2lido`
										},
									{
										"title": "3️⃣ محاضرة اولي  محاسبة مؤسسات ",
										"description": "ماده محاسبة مؤسسات بواسطة بوت بكار 🐼",
...
• الرابط -› https://t.me/MRLido7xBot?start=P0_0_3_0
════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_3_1
	════════ ××× ════════ٴ
...
case 'hqaqrtyhg3': 
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_3_2
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_3_3
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_4_0
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_4_1
	════════ ××× ════════ٴ
...
case 'محاسبة_مؤسسات_1': case 'mcss1lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
	-›  ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة محاسبة مؤسسات 1 😊
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	`
...
case 'محاسبة_مؤسسات_2': case 'mcss2lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
	-›  ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة محاسبة مؤسسات 2 😊
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
		`
...
case 'محاضرة_محاسبة_مؤسسات': case 'mcss3lido': {
	let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة محاضرة الاولي محاسبة شركات 😊
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
...
case 'امتحانات_محاسبة_مؤسسات': case 'mcss4lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة امتحانات محاسبة مؤسسات 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ 	`
...
case 'rebalido': {
	const sections = [	
							{
								"title": "⏺ قائمة مذكرات محاسبة ضريبة",
								"rows": [
									{
										"title": "1️⃣ مذكرة محاسبة ضريبة 1",
										"description": "ماده محاسبة ضريبة بواسطة بوت بكار 🐼",
										"rowId": `${prefix}reba1lido`
									},
									{
										"title": "2️⃣ مذكرة محاسبة ضريبة 2",
										"description": "ماده محاسبة ضريبة بواسطة بوت بكار 🐼",
										"rowId": `${prefix}reba2lido`
										},
									{
										"title": "3️⃣ محاضرة اولي  محاسبة ضريبة",
										"description": "ماده محاسبة ضريبة بواسطة بوت بكار 🐼",
										"rowId": `${prefix}reba3lido`
										},
										{
										"title": "*️⃣ مذكرة امتحانات محاسبة ضريبة",
										"description": "ماده محاسبة ضريبة بواسطة بوت بكار 🐼",
							...
							{
								"title": "⏺ قائمة شروحات محاسبة ضريبة",
								"rows": [
									{
										"title": "1️⃣ الحصة الاولي",
										"description": "ماده محاسبة ضريبة بواسطة بوت بكار 🐼",
...
const listMessage = {
  text: "- اختار المذكرة من قائمة مذكرات ⬇️",
  footer: `- اختار الشرح من قائمة شروحات ⬇️ `,
  title: `- نورت يا ${pushname} `,
  buttonText: " الــقــائمــة",
  sections
...
• الرابط -› https://t.me/MRLido7xBot?start=P0_0_4_2
════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_5_0
	════════ ××× ════════ٴ
...
case 'hygpiynn3': 
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_5_1
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_5_2
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_5_3
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_6_0
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_6_1
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_6_2
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_6_3
	════════ ××× ════════ٴ
...
case 'محاسبة_ضريبة_1': case 'reba1lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة ضريبة 1😍
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	`
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'commlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/محاسبة_ضريبة_1.pdf'),
		fileName : `مذكرة محاسبة ضريبة 1`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'محاسبة_ضريبة_2': case 'reba2lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›  ${ucapanWaktu}
-›  نورت يا ${pushname} 
...
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	...
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'commlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/محاسبة_ضريبة_2.pdf'),
		fileName : `مذكرة محاسبة ضريبة 2`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'محاضرة_محاسبة_ضريبة': case 'reba3lido': {
	let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
-›  ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاضرة الاولي محاسبة ضريبة 😊
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'commlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/محاضرة_محاسبة_ضريبة.pdf'),
		fileName : `محاضرة اولي محاسبة ضريبة`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'امتحانات_محاسبة_ضريبة': case 'reba4lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة امتحانات محاسبة ضريبة 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️  `
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'commlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/امتحانات_محاسبة_ضريبية.pdf'),
		fileName : `مذكرة امتحانات محاسبة ضريبة`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'tminlido': {
	const sections = [	
							{
								"title": "⏺ قائمة مذكرات تأمينات عامه",
								"rows": [
									{
										"title": "1️⃣ مذكرة تأمينات عامه 1",
										"description": "ماده تأمينات عامه بواسطة بوت بكار 🐼",
										"rowId": `${prefix}tmin1lido`
									},
									{
										"title": "2️⃣ مذكرة تأمينات عامه 2",
										"description": "ماده تأمينات عامه بواسطة بوت بكار 🐼",
										"rowId": `${prefix}tmin2lido`
										},
									{
										"title": "3️⃣ مذكرة تأمينات عامه عملي 3",
										"description": "ماده تأمينات عامه بواسطة بوت بكار 🐼",
										"rowId": `${prefix}tmin3lido`
										},
										{
										"title": "*️⃣ مذكرة امتحانات تأمينات عامه",
										"description": "ماده تأمينات عامه بواسطة بوت بكار 🐼",
							...
							{
								"title": "⏺ قائمة شروحات تأمينات عامه",
								"rows": [
									{
										"title": "1️⃣ الحصة الاولي",
										"description": "ماده تأمينات عامه بواسطة بوت بكار 🐼",
...
• الرابط -› https://t.me/MRLido7xBot?start=P0_0_7_0
════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_7_1
	════════ ××× ════════ٴ
...
case 'kihtterft3': 
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_7_2
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_7_3
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_7_4
	════════ ××× ════════ٴ
	...
	• الرابط -› https://t.me/MRLido7xBot?start=P0_0_7_5
	════════ ××× ════════ٴ
...
case 'تامينات_عامة_1': case 'tmin1lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة تأمينات عامة 1 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	`
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tminlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/تأمينات_عامة_1.pdf'),
		fileName : `مذكرة تأمينات عامة 1`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'تامينات_عامة_2': case 'tmin2lido': {
	let xeonwee = `
	ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة تأمينات عامة 2 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
		`
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tminlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/تامينات_عامة_2.pdf'),
		fileName : `مذكرة تأمينات عامة 2`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'تامينات_عامة_3': case 'tmin3lido': {
	let xeonwee = `ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة تامينات عامة عملي 3 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tminlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/تامينات_عامه_عملي.pdf'),
		fileName : `مذكرة تامينات عامه عملي`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'امتحانات_تامينات_عامة': case 'tmin4lido': {
	let xeonwee = `
	ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة امتحانات تأمينات عامة 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'tminlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/امتحانات_تأمينات_عامة.pdf'),
		fileName : `مذكرة امتحانات تأمينات عامة`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'enlshlido': {
	const sections = [	
							{
								"title": "⏺ قائمة مذكرات دراسات محاسبية باللغه الانجليزية",
								"rows": [
									{
										"title": "1️⃣ مذكرة دراسات محاسبية باللغه الانجليزية 1",
										"description": "ماده دراسات محاسبية باللغه الانجليزية بواسطة بوت بكار 🐼",
										"rowId": `${prefix}enlsh1lido`
									},
									{
										"title": "2️⃣ مذكرة دراسات محاسبية باللغه الانجليزية 2",
										"description": "ماده دراسات محاسبية باللغه الانجليزية بواسطة بوت بكار 🐼",
										"rowId": `${prefix}enlsh2lido`
										},
										{
										"title": "*️⃣ مذكرة امتحانات دراسات محاسبية باللغه الانجليزية",
										"description": "ماده دراسات محاسبية باللغه الانجليزية بواسطة بوت بكار 🐼",
							...
							{
								"title": "⏺ قائمة شروحات دراسات محاسبية باللغه الانجليزية",
								"rows": [
									{
										"title": "1️⃣ الحصة الاولي",
										"description": "ماده دراسات محاسبية باللغه الانجليزية بواسطة بوت بكار 🐼",
										...
										},
									{
										...
										{
										"title": "8️⃣ الحصة الثامنة والاخيرة",
										"description": "ماده دراسات محاسبية باللغه الانجليزية بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hygfywsh8`
										 }
								]
...
case '1_محاسبة_باللغه_الانجليزيه': case 'enlsh1lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة باللغه الانجليزيه 1 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	`
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'enlshlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/محاسبة_باللغه_الانجليزيه_1.pdf'),
		fileName : `مذكرة محاسبة باللغه الانجليزيه 1`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case '2_محاسبة_باللغه_الانجليزيه': case 'enlsh2lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة محاسبة باللغه الانجليزيه 2 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	...
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'enlshlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/محاسبة_باللغه_الانجليزيه_2.pdf'),
		fileName : `مذكرة محاسبة باللغه الانجليزيه 2`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'امتحانات_محاسبة_باللغه_الانجليزيه': case 'enlsh3lido': {
	let xeonwee = `
	ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة امتحانات محاسبة باللغه الانجليزيه 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'enlshlido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/امتحانات_دراسات_محاسبية_باللغه_الانجليزية.pdf'),
		fileName : `مذكرة امتحانات  محاسبة باللغه الانجليزيه`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
case 'hasblido': {
	const sections = [	
							{
								"title": "⏺ قائمة مذكرات  تطبيقات الحاسب",
								"rows": [
									{
										"title": "1️⃣ مذكرة  تطبيقات الحاسب 1",
										"description": "ماده تطبيقات الحاسب  بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hasb1lido`
									},
									{
										"title": "2️⃣ مذكرة  تطبيقات الحاسب 2",
										"description": "ماده تطبيقات الحاسب  بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hasb2lido`
										},
									{
										"title": "3️⃣ مذكرة  تطبيقات الحاسب 3",
										"description": "ماده تطبيقات الحاسب  بواسطة بوت بكار 🐼",
										"rowId": `${prefix}hasb3lido`
										},
										{
										"title": "*️⃣ مذكرة امتحانات  تطبيقات الحاسب ",
										"description": "ماده تطبيقات الحاسب  بواسطة بوت بكار 🐼",
							...
							{
								"title": "⏺ قائمة شروحات  تطبيقات الحاسب",
								"rows": [
									{
										"title": "قريبا -  1️⃣ الحصة الاولي",
										"description": "ماده تطبيقات الحاسب  بواسطة بوت بكار 🐼",
...
case 'تطبيقات_حاسب_1': case 'hasb1lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة تطبيقات  حاسب 1 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	`
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'hasblido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/تطبيقات_حاسب_1.pdf'),
		fileName : `مذكرة محاسبة باللغه الانجليزيه 1`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
...
case 'تطبيقات_حاسب_2': case 'hasb2lido': {
	let xeonwee = `
ـــــــــــــــــــــــــــــــــــــــــــــ
-›   ${ucapanWaktu}
-›  نورت يا ${pushname} 
-› خد يغالي/ة  مذكرة تطبيقات  حاسب 2 🤗
♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️
	...
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'hasblido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/تطبيقات_حاسب_2.pdf'),
		fileName : `مذكرة محاسبة باللغه الانجليزيه 2`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
...
case 'تطبيقات_حاسب_3': case 'hasb3lido': {
	let xeonwee = `
	ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› 3 خد يغالي/ة  مذكرة  تطبيقات  حاسب 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'hasblido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/تطبيقات_حاسب_3.pdf'),
		fileName : `مذكرة امتحانات  محاسبة باللغه الانجليزيه`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
...
case 'امتحانات_تطبيقات_الحاسب': case 'hasb4lido': {
	let xeonwee = `
	ـــــــــــــــــــــــــــــــــــــــــــــ
	-›   ${ucapanWaktu}
	-›  نورت يا ${pushname} 
	-› خد يغالي/ة  مذكرة امتحانات تطبيقات  حاسب 🤗
	♡⇜ لا تنسوني من صالح دعائكم 🤲❤️
	ـــــــــــــــــــــــــــــــــــــــــــــ
	⤵️︙ اليـكـ ازرار الدعم الفنـي خاصة بالبوت ♥️ `
	let buttons = [{ buttonId: 'duthgsf', buttonText: { displayText: 'الدعم الفنـي' }, type: 1 },{ buttonId: 'hasblido', buttonText: { displayText: 'عودة الي الــقــائمــة' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'المطور' }, type: 1 }]
	let buttonMessage = { 
		document: fs.readFileSync('./XeonMedia/file/امتحانات_تطبيقات_الحاسب.pdf'),
		fileName : `مذكرة امتحانات  تطبيقات  حاسب`,
		mimetype: `application/pdf`,             
		caption: xeonwee,
		footer: botname,
buttons: buttons,
...
//----------- enddd -------\\
	...
	let buttons = [
	{buttonId: `owner`, buttonText: {displayText: '● المطور ليدو ●'}, type: 1}
	]
	let buttonMessage = {
	...
	case 'بكارالاوامر': case 'الاوامر': case 'menu': case 'help': case '?': {
				let ownernya = ownernomer + '@s.whatsapp.net'
				let me = m.sender
				let timestampe = speed();
				let latensie = speed() - timestampe
...
🌟︙${ucapanWaktu} 
👋🏻︙نورت يا ${pushname} 
🤖︙أهلا بك انا بوت اسمي بكار
🔰︙تم برمجتي بواسطة : وليد محمد (ليدو)
🧑🏻‍💻︙مطوري »» 「 Dev Lido ☠️ مطور ليدو 」
💳︙رقمه »»  「 @${ownernya.split('@')[0]}」
⚙️︙وظيفتي مساعدك في منهج الترم الثاني 
🎮︙يمكنك ايضا العب معي 
ـــــــــــــــــــــــــــــــــــــــــــــ
⤵️︙ اليـكـ ازرار التحـكـم خاصة بالبوت💞`
				let ments = [ownernya, me, ini_mark]
				let buttons = [			
					{buttonId: `tslido`, buttonText: {displayText: '● مواد الترم الثاني ●'}, type: 1},		
	...
	سلبيات برج الدلو : مستقل وذكي. عنيد، يقف ضد الأمور، مشاكس، غير متوقع التصرفات، غير عاطفي وله استقلاليته.
	 ...
	 case 'الابراج': case 'برج': {
		XeonBotInc.sendMessage(from, { react: { text: `💖`, key: m.key }}) 
		let buttons = [
			{buttonId: `lido7xda`, buttonText: {displayText: '● معرفة برجك ●'}, type: 1},
